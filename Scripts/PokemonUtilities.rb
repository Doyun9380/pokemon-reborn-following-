...
ShitList = [PBSpecies::EXEGGUTOR,PBSpecies::KYUREM,PBSpecies::TANGROWTH,PBSpecies::STEELIX,PBSpecies::AVALUGG,PBSpecies::CLAWITZER,PBSpecies::SWALOT,PBSpecies::URAYNE,PBSpecies::TEDDINOMO,PBSpecies::GARCHOMP,PBSpecies::REGIGIGAS,PBSpecies::DEOXYS,PBSpecies::GRENINJA,PBSpecies::METALGREYMON,PBSpecies::MISSINGNO,PBSpecies::PALDIATINA, PBSpecies::ZYGARDE, PBSpecies::VIRCOBKION, PBSpecies::ARCEULUES, PBSpecies::BLINDINGGLIDER, PBSpecies::ZEKYUSHIRAM, PBSpecies::FROSLASS, PBSpecies::DELPHOX, PBSpecies::FLOETTEETERNAL,PBSpecies::ZACIAZENTUS, PBSpecies::CALYREX ,PBSpecies::CHROMARIDER ,PBSpecies::OMNIMON]
...
def pbLoadPokemonBitmapSpecies(pokemon, species, back=false)
  ...
  if pokemon.form ==0 && ShitList.include?(species)
    if (species == PBSpecies::METALGREYMON && pokemon.form == 0 || species == PBSpecies::VIRCOBKION && pokemon.form == 0 || species == PBSpecies::ARCEULUES && pokemon.form == 0 || species == PBSpecies::BLINDINGGLIDER || species == PBSpecies::ZEKYUSHIRAM && pokemon.form == 0 || species == PBSpecies::ZACIAZENTUS && pokemon.form == 0 || species == PBSpecies::OMNIMON && pokemon.form == 0) #mega steelix is excused.
			formnumber = "_"+pokemon.form.to_s
      shinytag = pokemon.isShiny? ? "s" : ""
      backtag = back ? "b" : ""
      if pbResolveBitmap(sprintf("Graphics/Battlers/%03d%s%s%s",species,shinytag,backtag,formnumber))
